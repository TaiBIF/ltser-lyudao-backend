...
from .views import GetWeatherTimeRangeView, GetWeatherDetailView, GetSeaTemperatureTimeRangeView, \
    ...
    SocialInterviewAPIView, SocialEconomyPopulationAPIView, SocialEconomyIndustryAPIView
...
urlpatterns = [
    ...
    path('social_economy/population', SocialEconomyPopulationAPIView.as_view(), name='get_social_economy_population'),
    path('social_economy/industry', SocialEconomyIndustryAPIView.as_view(), name='get_social_economy_industry'),
]