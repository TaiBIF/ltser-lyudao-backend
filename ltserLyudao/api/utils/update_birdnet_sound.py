...
metadata_url = (
    "https://data.depositar.io/api/3/action/package_show?id=ltser-lyudao-birdnetsound"
)
...
try:
    table_name = BirdNetSoundData._meta.db_table
        ...
        while not total_count:
            ...
            if response.status_code == 200:
                ...
                for record in records:
                    ...
                    sensitivity = validate_integer(
                        record.get("sensitivity"), "sensitivity", record
                    )
