...
print('Database: AquaticfaunaData')

# Step 1: Fetch metadata from API
metadata_url = 'https://data.depositar.io/api/3/action/package_show?id=ltser-lyudao-aquaticfauna'
...
try:
    AquaticfaunaData.objects.all().delete()
    ...
    for resource in resource_list:
        ...
        while not total_count:
            ...
            if response.status_code == 200:
                ...
                try:
                    AquaticfaunaData.objects.bulk_create(data_list)
                except Exception as e:
