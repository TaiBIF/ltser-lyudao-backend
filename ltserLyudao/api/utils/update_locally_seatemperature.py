...
try:
    SeaTemperatureData.objects.all().delete()
    print(f'Action: Successfully truncated table')
except Exception as e:
        ...
        with open(csv_file_path, 'r', encoding='utf-8') as csvfile:
            ...
            for row in reader:
                try:
                    ...
                    print(f"ERROR: Failed to process row {row} in file {csv_file}. Exception: {e}")
            ...
            try:
                ...
                for i in range(0, len(data_list), BATCH_SIZE):
                    ...
                    if not retry_bulk_create(batch):
                        ...
                        break
                print(f'Inserted {len(data_list)} records from {csv_file} into SeaTemperatureData.')
            except Exception as e:
                print(f'ERROR: Failed to insert records from {csv_file} into SeaTemperatureData. Exception: {e}')
    except Exception as e:
