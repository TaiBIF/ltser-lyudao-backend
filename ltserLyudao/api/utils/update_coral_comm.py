...
from api.utils.validate import validate_integer, validate_datetime, validate_decimal
...
metadata_url = (
    "https://data.depositar.io/api/3/action/package_show?id=ltser-lyudao-coralcomm"
)
...
try:
    table_name = CoralCommData._meta.db_table
