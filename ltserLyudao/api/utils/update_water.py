...
metadata_url = 'https://data.depositar.io/api/3/action/package_show?id=ltser-lyudao-water'
        ...
        while not total_count:
            ...
            if response.status_code == 200:
                ...
                for record in records:
                    ...
                    verbatimDepth = validate_decimal(record.get('verbatimDepth'), 'verbatimDepth', record)
                    ...
                    turbidity = validate_decimal(record.get('turbidity'), 'turbidity', record)
