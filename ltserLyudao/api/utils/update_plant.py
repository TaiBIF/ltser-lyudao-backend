...
metadata_url = (
    "https://data.depositar.io/api/3/action/package_show?id=ltser-lyudao-plant"
)
...
try:
    table_name = PlantData._meta.db_table
        ...
        while not total_count:
            ...
            if response.status_code == 200:
                ...
                for record in records:
                    ...
                    coordinatePrecision = validate_decimal(
                        record.get("coordinatePrecision"), "coordinatePrecision", record
                    )
                    ...
                    data_list.append(
                        PlantData(
                            ...
                            measurementDeterminedDate=record.get(
