...
from api.models import SeaTemperatureCK2023, SeaTemperatureDBS2023, SeaTemperatureGG2023, \
                       SeaTemperatureGW2023, SeaTemperatureNL2023, SeaTemperatureSL2023, \
                       SeaTemperatureWQG2023, SeaTemperatureYZH2023, SeaTemperatureZP2023

SEA_TEMPERATURE_TABLES = [SeaTemperatureCK2023, SeaTemperatureDBS2023, SeaTemperatureGG2023,
                          SeaTemperatureGW2023, SeaTemperatureNL2023, SeaTemperatureSL2023,
                          SeaTemperatureWQG2023, SeaTemperatureYZH2023, SeaTemperatureZP2023]
...
metadata_url = 'https://data.depositar.io/api/3/action/package_show?id=ltser-lyudao-seatemperature'
    ...
    for locationID, rows in grouped_data.items():
        ...
        for row in rows:
            ...
            try:
                ...
                seaTemperature = validate_decimal(row.get('seaTemperature'), 'seaTemperature', row)
        ...
        try:
            ...
            print(f'ERROR: Failed to insert records into {table.__name__}. Exception: {e}')
