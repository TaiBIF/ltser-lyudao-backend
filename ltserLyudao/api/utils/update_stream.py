...
metadata_url = (
    "https://data.depositar.io/api/3/action/package_show?id=ltser-lyudao-stream"
)
...
try:
    table_name = StreamData._meta.db_table
        ...
        while not total_count:
            ...
            if response.status_code == 200:
                ...
                for record in records:
                    ...
                    RPI_Score = validate_decimal(
                        record.get("RPI_Score"), "RPI_Score", record
                    )
