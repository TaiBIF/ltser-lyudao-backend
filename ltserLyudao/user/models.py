...
class FormLinkAttachment(models.Model):
    form_link = models.ForeignKey(
        FormLink, on_delete=models.CASCADE, related_name="formLinkAttachments"
    )
...
class NewsCoverImage(models.Model):
    news = models.OneToOneField(
        News, related_name="newsCoverImage", on_delete=models.CASCADE
    )
...
class NewsAttachment(models.Model):
    news = models.ForeignKey(
        News, on_delete=models.CASCADE, related_name="newsAttachments"
    )
...
class AboutAttachment(models.Model):
    about = models.ForeignKey(
        About, on_delete=models.CASCADE, related_name="aboutAttachments"
    )
    name = models.CharField(max_length=200)
    name_en = models.CharField(max_length=200, null=True, blank=True)
...
class DownloadRecord(models.Model):
    ...
    user = models.ForeignKey(
        MyUser, on_delete=models.CASCADE, related_name="download_records"
    )
    created_at = models.DateField(auto_now_add=True)
